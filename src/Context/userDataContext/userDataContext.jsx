...
export default function UserDataProvider({ children }) {
    ...
    async function getAllCustomersData() {
        try {
            const customersRes = await axios.get("https://ibrahimelagamy.github.io/customers-API/customers.json");
              const transactionsRes = await axios.get(
                "https://ibrahimelagamy.github.io/transactions-API/transactions.json"
              );
            setTransactionsData(transactionsRes?.data.transactions);
            setCustomersData(customersRes?.data.customers);
            setError(false);
        } catch (error) {
            setError(true);
        }
